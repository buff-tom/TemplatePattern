...
最新状态见 [恢复原缝合与1500步验证](恢复原缝合与1500步验证.md)，包含本轮命令及产物目录。旧文档中的新缝合重建策略已撤回。

最新修复与验收范围见 [修复与验证_2026-09-11.md](修复与验证_2026-09-11.md)：旧 Stage 1 需重新生成；提供材料参考、身高批测与 `/draco/` GLB 导出命令。
