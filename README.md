...
当前恢复状态与 1500 步验收见 [恢复原缝合与1500步验证](恢复原缝合与1500步验证.md)。原 reference 缝合已恢复，动态摆放不修改边界或 stitches；完整成衣质量仍未验收通过。

2026-09-11 修复、身高覆盖测试、材料配置及 Draco 命令见 [修复与验证](修复与验证_2026-09-11.md)。旧 Stage 1 的缩放语义点存在偏移，应重新生成任务包。
